...
public class AcoRole {
	...
	public void chooseOptions() throws InterruptedException{
		...
		driver.findElement(By.xpath("//mat-option[@id='mat-option-16']")).click();// B
		...
		// Subject	
		//subjectField.click();
		driver.findElement(By.xpath("//mat-option[@id='mat-option-33']")).click();// Computer Science
	...
	public void passMessage() throws InterruptedException{
		...
		messageField.sendKeys("Test- Assigning homework for computer science subject grade 3 B");
