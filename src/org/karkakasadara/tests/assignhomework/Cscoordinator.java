...
public class Cscoordinator {
	...
	public void chooseOptions() throws InterruptedException{
		...
		driver.findElement(By.xpath("//mat-option[@id='mat-option-0']")).click();// 5
				
		// Section
		WebElement sectionField= driver.findElement(By.xpath("//div[@id='mat-select-value-3']"));
		sectionField.click();
				
		driver.findElement(By.xpath("//mat-option[@id='mat-option-2']")).click();// A
		...
		// Subject	
		//subjectField.click();
		driver.findElement(By.xpath("//mat-option[@id='mat-option-3']")).click();// English
	...
	public void passMessage() throws InterruptedException{
		...
		messageField.sendKeys("Test- Assigning homework for English subject grade 5 A");
