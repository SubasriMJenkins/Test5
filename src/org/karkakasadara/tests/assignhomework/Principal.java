...
public class Principal {
		...
		public void clickViewCircular() throws InterruptedException{
			...
			if (driver.getTitle().equals("Result Analysis | Admission Status Approval")) {
				...
				wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//a[contains(text(),'Assign Homework')]"))).click();
		...
		public void chooseOptions() throws InterruptedException{
			...
			driver.findElement(By.xpath("//mat-option[@id='mat-option-0']")).click();// 4
			
			// Section
			WebElement sectionField= driver.findElement(By.xpath("//div[@id='mat-select-value-3']"));
			sectionField.click();
			
			driver.findElement(By.xpath("//mat-option[@id='mat-option-1']")).click();// A
			...
			// Subject	
			//subjectField.click();
			driver.findElement(By.xpath("//mat-option[@id='mat-option-2']")).click();// 2nd L Tamil
		...
		public void passMessage() throws InterruptedException{
			...
			messageField.sendKeys("Test- Assigning homework for 2nd L Tamil subject grade 4 A");
