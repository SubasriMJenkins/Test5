...
public class Student {
    ...
    for (WebElement card: eachCard) {
        try {
            ...
            WebElement postedMessage = card.findElement(By.xpath(".//div[contains(@class,'flex flex-col flex-auto p-6 bg-card shadow rounded-2xl overflow-hidden pt-6 px-5 pb-6 w-full pt-6 sm:col-span-6 mat-elevation-z0')]"));
