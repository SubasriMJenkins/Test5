...
public class DirectorAcademics {
	...
	public void selectFields() throws InterruptedException{
		...
		// School
		WebElement schoolField=wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[@id='mat-select-value-1']")));
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//mat-option[@id='mat-option-25']"))).click(); // 6
