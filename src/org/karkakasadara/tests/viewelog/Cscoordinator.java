...
public class Cscoordinator {                                     
	...
	public void selectFields() throws InterruptedException{
				...
				wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//mat-option[@id='mat-option-29']"))).click(); // 6
	...
	public void displayElogRecords() throws InterruptedException{
		...
		do {
			...
			System.out.println("All work completed!");			
		        ...
		        /* // Note field
		            WebElement noteField= driver.findElement(By.xpath("//div[contains(@class,'flex flex-col flex-auto p-6 bg-card shadow rounded-2xl overflow-hidden pt-6 px-5 pb-6 w-full sm:col-span-6 mat-elevation-z0 my-2 mr-2 ng-star-inserted')]"));
		            
		            if(noteField.isDisplayed()) {
		            	
		            	String noteOrAttachmentsMessage = noteField.getText();
		                
		                System.out.println(noteOrAttachmentsMessage);
		            	...
		            	System.out.println("No note/attchments found");
