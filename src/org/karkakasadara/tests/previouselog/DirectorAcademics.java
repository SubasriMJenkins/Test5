...
public class DirectorAcademics {
		...
		public void selectFields() throws InterruptedException{
			...
			// School
			WebElement schoolField=wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//mat-select[@id='mat-select-2']")));
			schoolField.click();
			wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//mat-option[@id='mat-option-1']"))).click(); // VNGS-MDM
				
			// Grade
			WebElement gradeField=wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[@id='mat-select-value-5']")));
			gradeField.click();
			wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//mat-option[@id='mat-option-24']"))).click(); // 5
				
			// section
			WebElement sectionField=wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[@id='mat-select-value-1']")));
			sectionField.click();
