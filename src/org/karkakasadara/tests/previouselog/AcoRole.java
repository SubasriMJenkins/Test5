...
public class AcoRole {
	...
	public void clickViewHomework() throws InterruptedException{
		...
		if (driver.getTitle().equals("Result Analysis | Admission Status Approval")) {
			...
			wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//a[contains(text(),'View Previous eLog')]"))).click();
			...
			wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//span[contains(text(),'View Previous eLog')]"))).click();
		}
	}
	...
	public void selectFields() throws InterruptedException{
		...
		gradeField.click();
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//mat-option[@id='mat-option-9']"))).click(); // 10
		
		// section
		WebElement sectionField=wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[@id='mat-select-value-1']")));
		sectionField.click();
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//mat-option[@id='mat-option-12']"))).click(); // A
